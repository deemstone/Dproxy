...
var _keypress_listeners;  //暂存所有stdin上监听keypress的函数
//开启/关闭keypress模式
exports.instantOn = function(cb){
	...
	//暂存所有keypress监听函数，移除他们
	_keypress_listeners = stdin.listeners('keypress');
...
exports.instantOff = function(){
	...
	//恢复其他所有keypress监听
	_keypress_listeners.forEach(function(l){
